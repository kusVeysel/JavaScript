...
if (Number(YakitTipi) === 1 || YakitTipi === "dizel" || Number(YakitTipi) === 2 || YakitTipi === "benzin" || Number(YakitTipi) === 3 || YakitTipi === "lpg") {
    ...
    if (Number(YakitTipi) === 1 || YakitTipi === "dizel") {
        ...
        OdenecekTutar <= Bakiye ? Bakiye -= OdenecekTutar && alert(`Yakıt Alma İşlemi Başarılı ${newline} Ödenen Miktar: ${OdenecekTutar + newline} Kalan Bakiye: ${Bakiye - OdenecekTutar}`) : alert(`Bakiyeniz Yeterli Değil ${newline} Ödenecek Tutar: ${OdenecekTutar + newline} Bakiyeniz: ${Bakiye + newline} Eksik Tutar: ${OdenecekTutar - Bakiye}`);
    }
